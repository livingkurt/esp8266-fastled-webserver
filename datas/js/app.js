...
function toggleCoolingSelector(pattern) {
	var coolingPatterns = [ 'Fire', 'Water' ];
...
function toggleTwinkleSelector(pattern) {
	var twinklePatterns = [ 'Rainbow Twinkles', 'Snow Twinkles', 'Cloud Twinkles', 'Incandescent Twinkles' ];
...
function toggleSpeedSelector(pattern) {
	// console.log('toggleSpeedSelector');
	// var speedPatterns = [  'Cycle Rainbow Desaturated' ];
	var speedPatterns = [ 'Sinelon', 'Beat', 'Cycle Rainbow Desaturated' ];
...
function togglePalletteSelector(pattern) {
	// console.log('togglePalletteSelector');
	var pallettePatterns = [ 'Confetti', 'Sinelon', 'Beat' ];
